    ...
    return (
      <div>
            <Routes >
                ...
                <Route path="/randomep" element={<RandomEpPage changeAuth={this.changeAuth} checkAuthData={this.checkAuthData}  changeRemoveAuth={this.changeRemoveAuth} className="tabContent"/>}/>
